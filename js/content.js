...
var BADGE_CLASSES = ['badge-blue', 'badge-green', 'badge-gold', 'badge-gray'];
...
function buildMetaHtml(item) {
  ...
  if (item.tags && item.tags.length) {
    var badges = item.tags.map(function (tag, i) {
      return '<span class="badge ' + BADGE_CLASSES[i % BADGE_CLASSES.length] + '">' + escapeHtml(tag) + '</span>';
    }).join('');
