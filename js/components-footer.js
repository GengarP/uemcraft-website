...
(function () {
  ...
  function renderFooter() {
    ...
    html += '<div class="footer-logo"><img src="/assets/img/logo-256.webp" alt="UEMCraft" width="36" height="36"><span>应急管理大学 Minecraft 同好会</span></div>';
    html += '<p>以 Minecraft 为平台，建设校园数字复原与创作社区。MUA 成员组织。</p>';
    ...
    html += '<li><a href="https://skin.uemcraft.cn/" target="_blank" rel="noopener">YIT &amp; UEM 皮肤站</a></li>';
    ...
    html += '<p class="fb-copy"><span class="copy-sym">&copy;</span> <span id="year"></span> 应急管理大学 Minecraft 同好会 - UEMCraft</p>';
    html += '<p class="fb-beian">';
    html += '<a href="https://beian.miit.gov.cn/" target="_blank" rel="noopener">赣ICP备2026018930号</a>';
    html += '<span class="footer-sep" aria-hidden="true"></span>';
    html += '<a href="https://beian.mps.gov.cn/" target="_blank" rel="noopener" class="beian-icon"><img src="/assets/img/备案图标.png" alt="" style="height:14px;width:auto;">赣公网安备 36072102000273号</a>';
    html += '</p>';
    html += '<p class="fb-trademark"><a href="https://www.minecraft.net/zh-hans" target="_blank" rel="noopener">Minecraft</a> 是微软公司的商标 - 本站为社群非商业用途</p>';
    html += '</div></footer>';
